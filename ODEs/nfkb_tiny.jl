...
@parameters e1a e2a i1 i1a k_deg k_prod kv t1 t2
...
@named model = ODESystem(
        [
            D(x1) ~ k_prod - k_deg * x1 - 0.1 * x1 * u,
            D(x2) ~
                -0.1 * x2 - k_deg * x2 - 0.1 * x2 * x10 + t1 * x4 -
                0.1 * x2 * x13 +
                t2 * x5 +
                (0.1 * x1 - 0.1 * x2 * x8) * u,
            D(x3) ~ 0.1 * x2 - k_deg * x3 + 0.1 * x2 * x8 * u,
            D(x4) ~ 0.1 * x2 * x10 - t1 * x4,
            D(x5) ~ 0.1 * x2 * x13 - t2 * x5,
            D(x6) ~ 0.1 * x13 - 0.1 * x6 * x10 + t2 * x5 - i1 * x6,
            D(x7) ~ i1 * kv * x6 - 0.1 * x11 * x7,
            D(x8) ~ 0.1 * x9 - 0.1 * x8,
            D(x9) ~ 0.1 - 0.1 * x7 - 0.1 * x9,
            D(x10) ~
                -0.1 * x2 * x10 - 0.1 * x10 * x6 + 0.1 * x12 - 0.1 * x10 -
                i1a * x10 + e1a * x11,
            D(x11) ~ -0.1 * x11 * x7 + i1a * kv * x10 - e1a * kv * x11,
            D(x12) ~ 0.1 + 0.1 * x7 - 0.1 * x12,
            D(x13) ~ 0.1 * x10 * x6 - 0.1 * x13 - 0.1 * x2 * x13 + e2a * x14,
            D(x14) ~ 0.1 * x11 * x7 - e2a * kv * x14,
