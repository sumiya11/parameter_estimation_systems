# MAPK (5 outputs) (with 16 parameters set to constants)
...
# Set the following parameters to 0.1 : a, alpha, gamma, c.
@parameters b00 b01 b10 beta01 beta10 beta11
...
@named model = ODESystem(
        [
         D(KS00) ~
                ...
                0.1 * FS11,
         D(KS01) ~
                -0.1 * K * S01 + b01 * KS01 + 0.1 * KS00 -
                0.1 * F * S01 +
                beta01 * FS01 +
                0.1 * FS11,
         D(KS10) ~
                -0.1 * K * S10 + b10 * KS10 + 0.1 * KS00 -
                0.1 * F * S10 +
                beta10 * FS10 +
                0.1 * FS11,
         D(FS01) ~
                ...
                0.1 * KS10 +
                0.1 * KS00,
                D(FS10) ~ 0.1 * K * S00 - (b00 + 0.1 + 0.1 + 0.1) * KS00,
                D(FS11) ~ 0.1 * K * S01 - (b01 + 0.1) * KS01,
          D(K) ~ 0.1 * K * S10 - (b10 + 0.1) * KS10,
          D(F) ~ 0.1 * F * S01 - (beta01 + 0.1) * FS01,
          D(S00) ~ 0.1 * F * S10 - (beta10 + 0.1) * FS10,
          D(S01) ~
                0.1 * F * S11 -
                (beta11 + 0.1 + 0.1 + 0.1) * FS11,
          D(S10) ~
                -0.1 * K * S00 + (b00 + 0.1 + 0.1 + 0.1) * KS00 -
                0.1 * K * S01 + (b01 + 0.1) * KS01 -
               0.1 * K * S10 + (b10 + 0.1) * KS10,
          D(S11) ~
                -0.1 * F * S01 + (beta01 + 0.1) * FS01 -
                0.1 * F * S10 + (beta10 + 0.1) * FS10 -
                0.1 * F * S11 +
                (beta11 + 0.1 + 0.1 + 0.1) * FS11,
         ], t, states, parameters)
